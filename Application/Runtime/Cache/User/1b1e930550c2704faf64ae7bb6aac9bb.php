...
<head lang="en">
    ...
    <!--<script type="text/javascript" src="/plugins/ueditor/ueditor/ueditor.all.min.js"></script>-->
    <!--<script type="text/javascript" src="/plugins/ueditor/ueditor/ueditor.parse.js"></script>-->
    <!--<script type="text/javascript" src="/plugins/ueditor/ueditor/ueditor.parse.min.js"></script>-->
    ...
    <?php if($type==0): ?><div class="coin-wrap">
        ...
        <div class="area_wrap">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <?php $__FOR_START_13088__=0;$__FOR_END_13088__=$count;for($i=$__FOR_START_13088__;$i < $__FOR_END_13088__;$i+=1){ ?><tr>
        ...
        <div>
            <table class="table table-striped table-bordered table-hover">
                ...
                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr lowId="<?php echo ($vo["id"]); ?>">
                        ...
                        <td>
                            <a content_id="<?php echo ($vo["id"]); ?>" class="news_modify btn btn-info btn-sm" href="">编辑</a>
                            <a content_id="<?php echo ($vo["id"]); ?>" class="news_delete btn btn-danger btn-sm" href="">删除</a>
                            <a class="btn btn-default btn-sm" href="/index.php/Coin/news?id=<?php echo ($vo["id"]); ?>">查看</a>
                        </td>
                    </tr><?php endforeach; endif; ?>
                </tbody>
            </table>
        ...
        <div>
            <table class="table table-bordered table-striped table-hover" style="width: 60%;margin: 0 auto">
                ...
                <?php if(is_array($list1)): foreach($list1 as $key=>$vo): ?><tr>
                        ...
                        <td>
                            <a uid="<?php echo ($vo["id"]); ?>" href="" class="user_delete btn btn-danger btn-sm">删除</a>
                        </td>
                    </tr><?php endforeach; endif; ?>
                </tbody>
            </table>
        </div>
        <div class="nav text-center"><?php echo ($page1); ?></div>
